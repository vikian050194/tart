...
**tart** is desktop web application for images viewing, searching, ordering and tagging.
...
1. Clone repos
  ```
  git clone https://github.com/vikian050194/tart-client.git
  git clone https://github.com/vikian050194/tart-server.git
  ```
2. TODO
